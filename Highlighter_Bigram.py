...
class Highlighter_Bigram:
    ...
    def init_tokenizer(self):
        ...
        self.data_tokenizer = pkl.load(open('bigram_data_tokenizer.pkl', 'rb'))
    ...
    def init_model(self):
        ...
        model.load_weights('bigram_model_D20171217_T0038_234_142_0.21_0.24.h5')
        self.model = model
    ...
    def get_scoring(self, sentence):
        ...
        for idx in range(0, len(seq)-NGRAM+1):
            ...
            word_score[self.data_index[seq[idx+1]]] = word_score.get(self.data_index[seq[idx+1]], 0) + cat
